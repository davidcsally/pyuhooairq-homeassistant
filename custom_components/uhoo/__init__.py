"""
Custom integration to integrate uHoo air sensors with Home Assistant.

For more details about this integration, please refer to
https://github.com/s28400/pyuhooairq-homeassistant
"""
import asyncio
...
async def async_unload_entry(hass: HomeAssistant, config_entry: ConfigEntry) -> bool:
    ...
    return unloaded"""uHooairq Custom Component Module"""
